...
public class SubscriberOperations implements Cloneable {
    ...
    /**
     * Retrieves the permission to see the subscriber.
    ...
    /**
     * Sets the permission to see the subscriber.
    ...
    /**
     * Retrieves the permission to delete the subscriber (this operation cannot be modified or overridden).
     * If {@code null}, the default permission is in effect.
     *
     * @return the permission, may be {@code null}
     */
    ...
    /**
     * Sets the permission to delete the subscriber (this operation cannot be modified or overridden).
     * If set to {@code null}, the default permission should be used.
     *
    ...
    /**
     * Creates and returns a copy of this {@code SubscriberOperations} object.
     *
