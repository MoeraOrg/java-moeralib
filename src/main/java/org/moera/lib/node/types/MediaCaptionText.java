...
public class MediaCaptionText extends Structure implements Cloneable {
    ...
    /**
     * Creates and returns a copy of this {@code MediaCaptionText} object.
     *
     * @return a clone of this instance
     */
    @Override
    public MediaCaptionText clone() {
        try {
            return (MediaCaptionText) super.clone();
