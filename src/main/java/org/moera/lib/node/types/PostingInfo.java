...
public class PostingInfo extends Structure implements Cloneable, MediaInfo {
    ...
    /**
     * Retrieves in addition to <code>heading</code>, gives a more detailed description of the posting that can be used
    ...
    /**
     * Sets in addition to <code>heading</code>, gives a more detailed description of the posting that can be used for
