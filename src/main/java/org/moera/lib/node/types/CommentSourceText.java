...
public class CommentSourceText extends Structure implements Cloneable {
    ...
    /**
     * Retrieves array of media to be attached to the comment.
     *
     * @return the value
     */
    ...
    /**
     * Sets array of media to be attached to the comment.
     *
    ...
    /**
     * Retrieves captions of the media to be attached to the comment.
     *
     * @return the value
     */
    ...
    /**
     * Sets captions of the media to be attached to the comment.
     *
