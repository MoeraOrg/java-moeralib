...
public class SearchCommentMediaUpdate extends Structure implements Cloneable {
    ...
    /**
     * Creates and returns a copy of this {@code SearchCommentMediaUpdate} object.
     *
     * @return a clone of this instance
     */
    @Override
    public SearchCommentMediaUpdate clone() {
        try {
            return (SearchCommentMediaUpdate) super.clone();
